...
export default function SignIn(){
    return(<section className="w-full flex h-screen justify-center  items-center">
        ...
        <div className="extra-bold text-4xl">Content Forge</div>
        <p className="text-center">Welcome, by continuing with content forge you will be a part of our community</p>
        <button className="flex gap-2 items-center bg-gray-500/50 hover:bg-gray-500/40 hover:pointer-cursor transition-colors duration-200 px-10 mb-4 text-lg py-2 rounded font-bold"> <Icons.GoogleLogo /> Signin</button>
    </div>
